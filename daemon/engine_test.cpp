...
void EngineTest::test( Engine *e )
{
    ...
    e->market_info[ TEST_MARKET ].spread.bid = "0.00000001";
    e->market_info[ TEST_MARKET ].spread.ask = "0.00000100";
    ...
    assert( e->positions->getTotalOrdersForSide( TEST_MARKET, SIDE_BUY  ) == 1 );
    assert( e->positions->getTotalOrdersForSide( TEST_MARKET, SIDE_SELL ) == 0 );
    ...
    QVector<Position*> pp;
    e->market_info[ TEST_MARKET ].spread.bid = "0.00000083";
    e->market_info[ TEST_MARKET ].spread.ask = "0.00000084";
    ...
    pp.clear();
    e->market_info[ TEST_MARKET ].spread.bid = "0.00000095";
    e->market_info[ TEST_MARKET ].spread.ask = "0.00000100";
    ...
    pp.clear();
    e->market_info[ TEST_MARKET ].spread.bid = "0.00000050";
    e->market_info[ TEST_MARKET ].spread.ask = "0.00000055";
    ...
    /// 4 4 4 4 | 5 5 5
    ///
    e->market_info[ TEST_MARKET ].spread.bid = "0.00000004";
    e->market_info[ TEST_MARKET ].spread.ask = "0.00000005";
    pp.clear();
    ...
    ///
    e->market_info[ TEST_MARKET ].spread.bid = "0.00000055";
    e->market_info[ TEST_MARKET ].spread.ask = "0.00000060";
    pp.clear();
    ...
    ///
    e->market_info[ TEST_MARKET ].spread.bid = "0.00000004";
    e->market_info[ TEST_MARKET ].spread.ask = "0.00000010";
    pp.clear();
...
//    e->market_info[ TEST_MARKET ].spread.bid = "0.00000023";
//    e->market_info[ TEST_MARKET ].spread.ask = "0.00000033";
//    pp.clear();
