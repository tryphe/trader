...
--------
 ...
 - [x] Anti-mistake. Prevents order taking 10% lower or higher from the current spread, [and more](https://github.com/tryphe/trader/blob/master/daemon/engine.cpp#L111)!
