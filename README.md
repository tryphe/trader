What is Trader?
---------------
Trader is a CLI bot that either makes manual orders for the user, and/or makes automatic ping-pong orders. Trader can make one-time, fill-or-kill, and maker/taker orders, and simulates these modes on exchanges without direct support. Trader also respects exchange limits like maximum number of orders, minimum price, maximum price, minimum lot size, price ticksize, etc.
